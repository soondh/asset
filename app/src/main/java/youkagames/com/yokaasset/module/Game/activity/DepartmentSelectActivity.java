...
import youkagames.com.yokaasset.module.Game.adapter.DepartmentSelectAdapter;
...
public class DepartmentSelectActivity extends BaseActivity implements IBaseView{
    ...
    private ArrayList<DepartmentListModel.DepartmentData> departmentDatas;
    ...
    public void RequestSuccess(BaseModel data) {
        if (data.cd == 0) {
            if (data instanceof DepartmentListModel) {
